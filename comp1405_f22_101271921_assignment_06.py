...
while (pos_p1_x + pos_p1_y) <= (275 + 350) and (pos_p2_x + pos_p2_y) <= (275 + 350):
    ...
    #sad attempt after confidence boost_________________________________________________________
    # if play_turn == 1:
    #     pos_x = pos_p1_x + (50 * the_dice_roll)
    #     for move in range(pos_p1_x, pos_x, 50):
    #         move = pos_p1_x
    #         if pos_p1_x > 300-25 and pos_p1_y < 350-38: # if player 1 reaches border, go down
    #             pos_p1_y += 50
    #             pos_p1_x -= 50*6
    #     play_turn = 2
    #boost end_______________________________________________________________________________
