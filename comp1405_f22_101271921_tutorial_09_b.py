...
def main():
    ...
    if the_boolean == False:
        print(f"Failed! Not all lists were sorted out. It took an average of {((end_bogosort-start_bogosort)/run_time):.20} seconds for Bozosort to try to sort them out.")
    else:
        print(f"Success! It took an average of {((end_bogosort-start_bogosort)/run_time):.20} seconds for Bozosort to sort them all.")
